  ...
  return (
    <div className="flex justify-center max-sm:h-full max-sm:py-10 h-screen items-center">
      <form
        ...
        className={` w-96 max-[450px]:w-[90%] max-[350px]:gap-3 flex flex-col ${
          bgTexture?.white ? "bgTransparent2 shadow2" : "bgTransparent shadow"
        } gap-5 rounded`}
      >
        ...
        <h1
          className={`text-center ${
            bgTexture?.white ? "text-black" : "text-white"
          } font-medium`}
        >
          SIGN UP
        </h1>
        <div className="flex flex-col mx-7 gap-4">
          <div className="relative flex flex-col">
            <input
              ...
              className={`${
                bgTexture?.white ? "custom-input2" : "custom-input"
              } px-3 py-[10px] rounded`}
            />
            <SlUser
              className={`${
                bgTexture?.white ? "text-black" : "text-white opacity-80"
              } absolute top-[10px] right-[17px]`}
            />
          </div>
          <div className="relative flex flex-col">
            <input
            ...
            <HiOutlineMailOpen
              className={`${
                bgTexture?.white ? "text-black" : "text-white opacity-80"
              }  text-lg absolute top-[10px] right-4`}
            />
          </div>
          <div className="relative flex flex-col">
            <input
        ...
        <div className="flex items-center mx-7">
          <input
            ...
            checked
            className={`${
              bgTexture?.white ? "custom-checkbox2" : "custom-checkbox"
            }`}
          />
          <label
            htmlFor="termsCheckbox"
            className={`${
              bgTexture?.white ? " text-black" : " text-gray-200"
        ...
        {isLoading ? (
          <button
            ...
            className={`${
              bgTexture?.white
                ? "bg-blue-700 hover:bg-blue-950 duration-500"
                : "btn"
            } font-medium mx-7 tracking-wider text-white text-xs shadow-md h-9 rounded flex items-center justify-center gap-2`}
          >
          ...
          <button
            disabled={isLoading && true}
            className={`${bgTexture?.white ? "bg-blue-700 hover:bg-blue-950 duration-500" : "btn"} font-medium mx-7 tracking-wider text-white text-xs shadow-md py-[10px] rounded`}
          >
            SIGN UP
          </button>
        )}
